...
async function p(e) {
    ...
    (function (e) {
        ...
        const p = async (purposeCode) => {
            ...
            t("dob_id", e.dob);
            // Apply configured journey date from settings (always prioritize settings if configured)
            ...
            if (["15", "30", "45"].includes(_m) && !isNaN(_d) && _d > 0) {
                ...
                _calcDate = `${String(_dt.getDate()).padStart(2, "0")}/${String(_dt.getMonth() + 1).padStart(2, "0")}/${_dt.getFullYear()}`;
            } else if (_jS?.defaultJourneyDate && _jS.defaultJourneyDate.trim()) {
                _calcDate = _jS.defaultJourneyDate.trim();
